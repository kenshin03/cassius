...
- (void) initFlip {
    ...
    NSLog(@"initFlip self.currentView: %@", self.currentView);
    NSLog(@"initFlip self.newView: %@", self.newView);
...
- (BOOL) doSetCurrentPage:(NSInteger) value {
    ...
    NSLog(@"doSetCurrentPage: value:%i", value);
    ...
    NSLog(@"doSetCurrentPage: flipDirection:%i", flipDirection);
	
	currentPage = value;
    NSLog(@"doSetCurrentPage: currentPage:%i", currentPage);
	
	self.newView = [self.dataSource viewForPage:value inFlipper:self];
    NSLog(@"doSetCurrentPage self.newView: viewForPage:%i", value);
